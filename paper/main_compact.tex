...
This work presents the complete Trinary system across 36 chapters organized into eight
parts:
\begin{itemize}
...
The simulated GPU (\texttt{gpu.py}) extends the accelerator model with a parallel
...
ASCII rendering tools in \texttt{viz.py}:
\begin{verbatim}
...
\texttt{test\_gpu.py} & GPU mode, kernel dispatch, visualization & 19 \\
